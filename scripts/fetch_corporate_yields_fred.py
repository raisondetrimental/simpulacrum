#!/usr/bin/env python3
"""
Fetch ICE BofA Global Corporate Bond Effective Yields from FRED
and append new dates to backend/data/json/Markets/Corporate_Yields.json
...
Series included (%, Effective Yields):
Global HY BAMLH0A0HYM2EY, Global IG (BBB) BAMLC0A4CBBBEY,
EM Corporate BAMLEMHBHYCRPIEY, EM Asia BAMLEMRACRPIASIAEY,
EM EMEA BAMLEMRECRPIEMEAEY, EM LatAm BAMLEMRLCRPILAEY
"""
...
SERIES = {
    "BAMLH0A0HYM2EY": "global_hy",
    "BAMLC0A4CBBBEY": "global_ig_bbb",
    "BAMLEMHBHYCRPIEY": "em_corporate",
    "BAMLEMRACRPIASIAEY": "em_asia",
    "BAMLEMRECRPIEMEAEY": "em_emea",
    "BAMLEMRLCRPILAEY": "em_latam",
}
...
OUT_FILE = OUT_DIR / "Corporate_Yields.json"
...
output = {
    "meta": {
        ...
        "notes": "ICE BofA Global Corporate Bond Effective Yields (%). Missing days are None, typically weekends or holidays. Data accumulated incrementally.",

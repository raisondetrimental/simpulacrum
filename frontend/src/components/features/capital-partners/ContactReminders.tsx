 ...
 * Shows upcoming contact follow-ups on liquidity landing page
 */
...
const ContactReminders: React.FC = () => {
      ...
      {reminders.map((reminder) => {
        ...
        return (
          <Link
            ...
            to={`/liquidity/meeting-notes/${reminder.contact.id}`}

...
const AllOverviewPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add Organisation Cards */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Add New Organisation</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Add Capital Partner */}
          <Link
          ...
          >
            <div className="flex items-center justify-center flex-col py-6">
              ...
              <p className="text-sm text-gray-600 mt-1 text-center">Create capital partner</p>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center justify-center flex-col py-6">
              ...
              <p className="text-sm text-gray-600 mt-1 text-center">Create corporate</p>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center justify-center flex-col py-6">
              ...
              <p className="text-sm text-gray-600 mt-1 text-center">Create legal advisor</p>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center justify-center flex-col py-6">
              ...
              <p className="text-sm text-gray-600 mt-1 text-center">Create agent</p>
            </div>
          </Link>
        </div>
      </div>

/**
 * Counsel Overview Page - Landing page for counsel/legal advisors module
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        <h1 className="text-3xl font-bold text-gray-900">Counsel</h1>
        <p className="text-gray-600 mt-1">Manage legal advisor relationships and counsel contacts</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Add Legal Advisor */}
        <Link
          to="/counsel/legal-advisors?add=true"
        ...
        >
          <div className="flex items-center justify-center flex-col py-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Add Legal Advisor</h3>
            <p className="text-sm text-gray-600 mt-1">Create new legal advisor</p>
          </div>
        </Link>
        ...
        {/* Legal Advisors - Main Interface */}
        <Link
          to="/counsel/legal-advisors"
          className="card hover:shadow-lg transition-shadow cursor-pointer bg-indigo-50 border-2 border-indigo-200"
        >
          <div className="flex items-center justify-center flex-col py-6">
            ...
            <p className="text-sm text-gray-600 mt-1">Browse legal advisors & contacts</p>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center justify-center flex-col py-6">
            ...
            <p className="text-sm text-gray-600 mt-1">Filter by preferences & region</p>
          </div>
        </Link>
      </div>
          ...
          <div className="space-y-3">
            {recentMeetings.map((item, index) => (
              <button
                ...
                className="w-full text-left border border-gray-200 rounded-md p-4 hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              >
                ...
                <p className="mt-2 text-xs font-semibold text-purple-600">Open full details</p>
              </button>
            ))}
          </div>
        )}
...
export default CounselOverview;
